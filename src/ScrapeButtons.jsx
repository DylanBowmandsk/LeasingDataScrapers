const ScrapeButtons = ({make, model, variant, derivative, term, initialTerm, mileage,  setLeasingData, setLocoData, setSelectData, setPvData}) => {
    ...
    <div className="mx-5 my-3" id="scraper-button-container">
        ...
        <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-2" onClick={() => {scrapeAll(make, model, variant, derivative,term, initialTerm, mileage, setLeasingData, setSelectData, setLocoData, setPvData)}}>Scrape Data</button>
      </div>
    )
}
